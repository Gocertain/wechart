...
function userEdit() {
	...
	for (i = 7; i < frm.elements.length - 2; i++) // 浠庣涓冮」寮€濮嬪惊鐜鏌ユ槸鍚︿负蹇呭～椤�
	{
...
function register() {
	...
	for (i = 4; i < frm.elements.length - 4; i++) // 浠庣浜旈」寮€濮嬪惊鐜鏌ユ槸鍚︿负蹇呭～椤�
	{
		needinput = document.getElementById(frm.elements[i].name + 'i') ? document
				.getElementById(frm.elements[i].name + 'i')
				: '';
...
/*******************************************************************************
 * 璁㈠崟涓殑鍟嗗搧杩斿洖璐墿杞� @param int orderId 璁㈠崟鍙�
 */
...
/*******************************************************************************
 * 妫€娴嬪瘑鐮佸己搴� @param string pwd 瀵嗙爜
 */
